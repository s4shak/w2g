...
<c:set value="${pageContext.request.contextPath}/resources/pinkTheme" var="resourcesPathPrefix" scope="page"  />
<c:set value="${resourcesPathPrefix}/css" var="cssHome" scope="page" />
<c:set value="${resourcesPathPrefix}/js" var="jsHome" scope="page" />
<c:set value="${resourcesPathPrefix}/img" var="imagesHome" scope="page" />
<c:set value="${resourcesPathPrefix}/theme" var="themeUIHome" scope="page" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
				...
				<div class="hobbyItem sortable" id="interest_0">
					...
					<div class="hobbyContent" >
						<table >
							...
							<tr>
								<td>Gear you need:  <img src="${imagesHome}/add.png" class="addGearItem gown" alt="Add Item" title="Add Item" />
								<div>
